    ...
    <>
      ...
      <div className="bg-[rgb(var(--background))] text-[rgb(var(--copy-primary))] py-16 px-6">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          {/* 2. Itinerary Builder */}
          <section>
            <h2 className="text-3xl font-bold mb-4">Your Itinerary</h2>
            {itinerary.length === 0 ? (
              ...
              <div className="space-y-6">
                {itinerary.map((item, idx) => (
                  <div
                    key={item.id}
                    className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-2xl p-6 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-4 items-center"
                  >
                    <div className="md:col-span-1">
                      ...
                      <div className="flex gap-2 text-sm">
                        <button
                          ...
                          className="px-2 py-1 rounded bg-[rgb(var(--cta))] text-[rgb(var(--cta-text))] hover:bg-[rgb(var(--cta-active))]"
                        >
                          ↑
                        </button>
                        <button
                    ...
                    <div className="md:col-span-2 flex flex-col sm:flex-row gap-4">
                      <div className="flex-1">
                        ...
                        <DatePicker
                          ...
                          className="w-full px-4 py-2 rounded-xl border border-[rgb(var(--border))] focus:outline-none"
                        />
                      </div>
                      <div className="flex-1">
                        <label className="block text-sm mb-1">
                        ...
                        <DatePicker
                          ...
                          onChange={(d) => updateDates(item.id, "departure", d)}
                          className="w-full px-4 py-2 rounded-xl border border-[rgb(var(--border))] focus:outline-none"
                        />
                      </div>
                    </div>
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="px-6 py-3 rounded-xl bg-[rgb(var(--cta))] hover:bg-[rgb(var(--cta-active))] text-[rgb(var(--cta-text))] font-semibold"
                  >
                    Save Itinerary
                  </button>
                  <button
